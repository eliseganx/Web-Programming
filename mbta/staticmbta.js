...
function setRedLine() {
  ...
  Alewife.setMap(map);
  Alewife.addListener("mouseover", function() {infowindow.setContent("<center>" + Alewife.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Alewife);});
  ...
  Davis.setMap(map);
  Davis.addListener("mouseover", function() {infowindow.setContent("<center>" + Davis.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Davis);});
  ...
  Porter.setMap(map);
  Porter.addListener("mouseover", function() {infowindow.setContent("<center>" + Porter.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Porter);});
  ...
  Harvard.setMap(map);
  Harvard.addListener("mouseover", function() {infowindow.setContent("<center>" + Harvard.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Harvard);});
  ...
  Central.setMap(map);
  Central.addListener("mouseover", function() {infowindow.setContent("<center>" + Central.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Central);});
  ...
  Kendall.setMap(map);
  Kendall.addListener("mouseover", function() {infowindow.setContent("<center>" + Kendall.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Kendall);});
  ...
  Charles.setMap(map);
  Charles.addListener("mouseover", function() {infowindow.setContent("<center>" + Charles.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Charles);});
  ...
  Park.setMap(map);
  Park.addListener("mouseover", function() {infowindow.setContent("<center>" + Park.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Park);});
  ...
  DowntownCrossing.addListener("mouseover", function() {infowindow.setContent("<center>" + DowntownCrossing.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, DowntownCrossing);});
  ...
  SouthStation.addListener("mouseover", function() {infowindow.setContent("<center>" + SouthStation.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, SouthStation);});
  ...
  Broadway.setMap(map);
  Broadway.addListener("mouseover", function() {infowindow.setContent("<center>" + Broadway.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Broadway);});
  ...
  Andrew.setMap(map);
  Andrew.addListener("mouseover", function() {infowindow.setContent("<center>" + Andrew.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Andrew);});
  ...
  JFK.setMap(map);
  JFK.addListener("mouseover", function() {infowindow.setContent("<center>" + JFK.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, JFK);});
  ...
  SavinHill.addListener("mouseover", function() {infowindow.setContent("<center>" + SavinHill.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, SavinHill);});
  ...
  FieldsCorner.addListener("mouseover", function() {infowindow.setContent("<center>" + FieldsCorner.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, FieldsCorner);});
  ...
  Shawmut.setMap(map);
  Shawmut.addListener("mouseover", function() {infowindow.setContent("<center>" + Shawmut.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Shawmut);});
  ...
  Ashmont.setMap(map);
  Ashmont.addListener("mouseover", function() {infowindow.setContent("<center>" + Ashmont.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Ashmont);});
  ...
  NorthQuincy.addListener("mouseover", function() {infowindow.setContent("<center>" + NorthQuincy.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, NorthQuincy);});
  ...
  Wollaston.addListener("mouseover", function() {infowindow.setContent("<center>" + Wollaston.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Wollaston);});
  ...
  QuincyCenter.addListener("mouseover", function() {infowindow.setContent("<center>" + QuincyCenter.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, QuincyCenter);});
  ...
  QuincyAdams.addListener("mouseover", function() {infowindow.setContent("<center>" + QuincyAdams.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, QuincyAdams);});
  ...
  Braintree.addListener("mouseover", function() {infowindow.setContent("<center>" + Braintree.title + "</br>" + "Add /redline to URL for train info </center>"); infowindow.open(map, Braintree);});
